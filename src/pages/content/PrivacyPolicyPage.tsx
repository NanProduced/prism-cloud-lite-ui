...
For the purposes of this Privacy Policy:
  ...
  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to Prism Cloud Lite.
  ...
  * Website refers to Prism Cloud Lite, accessible from
    <https://prism.nanproduced.cloud>
...
processing are located. It means that this information may be transferred to 鈥?
and maintained on 鈥?computers located outside of Your state, province, country
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-tight">
                Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-indigo-400">Policy</span>
              </h1>
              <div className="flex items-center justify-center gap-4 text-slate-400 text-sm font-medium">
                ...
                <span className="flex items-center gap-1.5">
                  <FileText size={14} /> Official Legal Document
                </span>
              </div>
            </div>
            ...
            {/* Support Box */}
            <div className="mt-12 p-8 rounded-3xl bg-indigo-500/5 border border-indigo-500/10 text-center">
